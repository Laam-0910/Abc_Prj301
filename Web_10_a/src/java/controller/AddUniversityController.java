...
public class AddUniversityController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean idDraft = (s_isDraft.equals("1")) ? true : false;
            u = new UniversityDTO(id, name, shortName, description, foundedYear, address, city, region, type, totalStudents, totalFaculties, idDraft);
            if (error.isEmpty()) {
                //khong co loi
                if (udao.add(u)) {
