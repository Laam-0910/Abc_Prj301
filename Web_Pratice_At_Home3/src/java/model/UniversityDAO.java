...
public class UniversityDAO {
    ...
    public ArrayList<UniversityDTO> searchByName(String username) {
    ...
    public ArrayList<UniversityDTO> filterByName(String username) {
        return filterByColumn("username", username);
    }
}
